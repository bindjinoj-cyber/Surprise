...
function catBlink() {
    ...
    setTimeout(() => {
        ...
        catEyeLeft.textContent = left;
        catEyeRight.textContent = right;
...
setInterval(() => {
    ...
    if (
        catContainer &&
        catContainer.classList.contains("show")
    ) {
